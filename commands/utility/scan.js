module.exports = {
  ...
  execute(message, args) {
    ...
    async function quickstart() {
      ...
      let embedOCR_success = new Discord.MessageEmbed()
        .setTitle("¡Escaneo completado!")
        .setColor("#32a852");
      let embedOCR_failed = new Discord.MessageEmbed()
      ...
      let textLenght;
      try {
        let [result] = await clientVision.textDetection("./unknown.png");
        let annotation = result.textAnnotations[0];
